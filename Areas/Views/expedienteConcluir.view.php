                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Visualizando Expediente</h5>
                                        ...
                                        <div class="form-row">
                                          ...
                                          <div class="col-md-12">
                                              <div class="position-relative form-group"><label  class="">Detalle de Expediente a Concluir</label>
                                                <input name="detalle" id="detalle" placeholder="Ingrese el mensaje" type="text" class="form-control" autocomplete="off">
                                              </div>
                                          </div>
                                        </div>
