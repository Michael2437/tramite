                    ...
                    <div class="scrollbar-sidebar">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li >
                                    <a href="modificarExpediente.php" class="mm-active">
                                        <i class="metismenu-icon pe-7s-rocket"></i>
                                        Expediente
                                    </a>
                                </li>
                                      ...
                                      <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                          <div class="position-relative form-group">
                                            <input name="nExp" id="nExp" type="number" value="<?php if(isset($idDoc)){echo $idDoc;} ?>" placeholder="N° Expediente" class="form-control">
                                          </div>
                                        </div>
                                        <div class="col-md-3">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                <div>
                <h5 class="modal-title" id="exampleModalLabel">Expediente Modificado</h5>
                </div>
                <div>
